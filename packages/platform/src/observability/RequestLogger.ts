import { createLogger, LogFn } from './logger';
...
class RequestLogger {
  constructor(private readonly log: LogFn = createLogger('service')) {}

  started(trace: RequestTrace): void {
    this.log('request_started', trace);
  }
